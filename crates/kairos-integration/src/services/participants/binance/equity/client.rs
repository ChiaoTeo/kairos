...
impl BinanceEquityRestClient {
    pub fn with_base_url(
        ...
        Ok(Self {
            ...
            async_http: AsyncPublicHttpClient::new("kairos-integration/binance-equity")?,
            api_key,
            secret,
            base_url,
        })
    ...
    pub async fn exchange_info_async(&self) -> Result<Value, ExchangeError> {
        self.async_http
            .get_json_response_with_headers_and_query(
                &format!("{}/sapi/v1/equity/market/exchangeInfo", self.base_url),
                &[],
