...
use super::protocol::AccountMarketProfileSource;
use crate::application::account::protocol::{AccountSnapshotSource, AccountStateStore};
...
impl AccountApplication {
    ...
    pub fn actor_mut(&mut self) -> &mut AccountActor {
        &mut self.actor
    }
    ...
    pub fn plan_order_with_risk(
        ...
        request: crate::domain::OrderRequest,
        at: u64,
        risk: &mut dyn crate::application::account::protocol::OrderRisk,
    ) -> Result<OrderState, AccountError> {
