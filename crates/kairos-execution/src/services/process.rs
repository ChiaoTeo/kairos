use crate::application::{
    ...
    ExecutionAuditQuery, ExecutionFillReport, RemoteOrderQuery, ReplaceOrder, SubmitOrder,
};
use crate::composition::SqliteExecutionAudit;
...
pub struct ExecutionProcess {
    ...
    socket_path: PathBuf,
    audit: Option<SqliteExecutionAudit>,
    stopping: bool,
}
...
impl ExecutionProcess {
    ...
    ) -> Result<Vec<crate::application::ExecutionAuditEvent>, crate::application::ExecutionError>
    {
