...
impl<'a> Position<'a> {
    ...
    pub fn quantity(&self) -> &'a super::super::common::v_2::Decimal64 {
        ...
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(Position::VT_QUANTITY, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn average_price(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(Position::VT_AVERAGE_PRICE, None)
        }
    }
    #[inline]
    pub fn mark_price(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        ...
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(Position::VT_MARK_PRICE, None)
        }
    }
    #[inline]
    pub fn unrealized_pnl(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(Position::VT_UNREALIZED_PNL, None)
        }
    }
    #[inline]
    pub fn realized_pnl(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(Position::VT_REALIZED_PNL, None)
        }
    }
    #[inline]
    pub fn observed_at_unix_nanos(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(Position::VT_OBSERVED_AT_UNIX_NANOS, Some(0))
                .unwrap()
        }
    }
}
...
pub struct PositionArgs<'a> {
    ...
    pub unrealized_pnl: Option<&'a super::super::common::v_2::Decimal64>,
    pub realized_pnl: Option<&'a super::super::common::v_2::Decimal64>,
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> PositionBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_average_price(&mut self, average_price: &super::super::common::v_2::Decimal64) {
        self.fbb_
            .push_slot_always::<&super::super::common::v_2::Decimal64>(
    ...
    #[inline]
    pub fn add_unrealized_pnl(&mut self, unrealized_pnl: &super::super::common::v_2::Decimal64) {
        self.fbb_
            .push_slot_always::<&super::super::common::v_2::Decimal64>(
    ...
    #[inline]
    pub fn add_realized_pnl(&mut self, realized_pnl: &super::super::common::v_2::Decimal64) {
        self.fbb_
            .push_slot_always::<&super::super::common::v_2::Decimal64>(
    ...
    pub fn add_observed_at_unix_nanos(&mut self, observed_at_unix_nanos: u64) {
        self.fbb_.push_slot::<u64>(
            Position::VT_OBSERVED_AT_UNIX_NANOS,
            observed_at_unix_nanos,
            0,
        );
    }
    ...
    pub fn finish(self) -> ::flatbuffers::WIPOffset<Position<'a>> {
        ...
        self.fbb_.required(o, Position::VT_MARKET_ID, "market_id");
