...
impl<'a> Rate<'a> {
    ...
    #[inline]
    pub fn value(&self) -> &'a super::super::common::v_2::Decimal64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(Rate::VT_VALUE, None)
                .unwrap()
        }
    }
    #[inline]
    pub fn mark_price(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        ...
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(Rate::VT_MARK_PRICE, None)
        }
    }
    #[inline]
    pub fn source_observed_at_unix_nanos(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(Rate::VT_SOURCE_OBSERVED_AT_UNIX_NANOS, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn received_at_unix_nanos(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(Rate::VT_RECEIVED_AT_UNIX_NANOS, Some(0))
                .unwrap()
        }
    }
}
...
impl ::flatbuffers::Verifiable for Rate<'_> {
    ...
    fn run_verifier(
        ...
        v.visit_table(pos)?
            ...
            .visit_field::<super::super::common::v_2::Decimal64>("value", Self::VT_VALUE, true)?
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> RateBuilder<'a, 'b, A> {
    ...
    #[inline]
    pub fn add_value(&mut self, value: &super::super::common::v_2::Decimal64) {
        self.fbb_
            .push_slot_always::<&super::super::common::v_2::Decimal64>(Rate::VT_VALUE, value);
    }
    #[inline]
    ...
    pub fn add_source_observed_at_unix_nanos(&mut self, source_observed_at_unix_nanos: u64) {
        self.fbb_.push_slot::<u64>(
            Rate::VT_SOURCE_OBSERVED_AT_UNIX_NANOS,
            source_observed_at_unix_nanos,
            0,
        );
    }
    ...
    pub fn add_received_at_unix_nanos(&mut self, received_at_unix_nanos: u64) {
        self.fbb_
            .push_slot::<u64>(Rate::VT_RECEIVED_AT_UNIX_NANOS, received_at_unix_nanos, 0);
    }
    #[inline]
