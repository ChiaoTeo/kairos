...
impl<'a> FundingRate<'a> {
    ...
    pub const VT_FUNDING_RATE: ::flatbuffers::VOffsetT = 8;
    pub const VT_FUNDING_PERIOD_SECONDS: ::flatbuffers::VOffsetT = 10;
    pub const VT_NEXT_FUNDING_TIME_UNIX_NANOS: ::flatbuffers::VOffsetT = 12;
    ...
    #[inline]
    pub fn funding_rate(&self) -> &'a super::super::common::v_1::Decimal64 {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<super::super::common::v_1::Decimal64>(FundingRate::VT_FUNDING_RATE, None)
                .unwrap()
        }
    }
    #[inline]
    ...
    pub fn event_time_unix_nanos(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(FundingRate::VT_EVENT_TIME_UNIX_NANOS, Some(0))
                .unwrap()
        }
    }
    #[inline]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> FundingRateBuilder<'a, 'b, A> {
    ...
    pub fn add_event_time_unix_nanos(&mut self, event_time_unix_nanos: u64) {
        self.fbb_.push_slot::<u64>(
            FundingRate::VT_EVENT_TIME_UNIX_NANOS,
            event_time_unix_nanos,
            0,
        );
    }
