...
impl<'a> ExecutionAccess<'a> {
    ...
    pub const VT_SETTLEMENT_ASSET_ID: ::flatbuffers::VOffsetT = 14;
    ...
    pub fn status(&self) -> &'a str {
        ...
        unsafe {
            self._tab
                .get::<::flatbuffers::ForwardsUOffset<&str>>(ExecutionAccess::VT_STATUS, None)
                .unwrap()
        }
    }
    #[inline]
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> ExecutionAccessBuilder<'a, 'b, A> {
    ...
    pub fn add_status(&mut self, status: ::flatbuffers::WIPOffset<&'b str>) {
        self.fbb_
            .push_slot_always::<::flatbuffers::WIPOffset<_>>(ExecutionAccess::VT_STATUS, status);
    }
    #[inline]
    ...
    pub fn finish(self) -> ::flatbuffers::WIPOffset<ExecutionAccess<'a>> {
        ...
        self.fbb_.required(o, ExecutionAccess::VT_STATUS, "status");
