...
pub const ENUM_MIN_SIDE: u8 = 0;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
pub const ENUM_MAX_SIDE: u8 = 2;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_SIDE: [Side; 3] = [Side::UNSPECIFIED, Side::BUY, Side::SELL];
...
impl Side {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::UNSPECIFIED, Self::BUY, Self::SELL];
