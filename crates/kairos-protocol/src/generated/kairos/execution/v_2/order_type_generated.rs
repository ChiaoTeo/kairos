...
pub const ENUM_MAX_ORDER_TYPE: u8 = 4;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
#[allow(non_camel_case_types)]
pub const ENUM_VALUES_ORDER_TYPE: [OrderType; 5] = [
...
impl OrderType {
    ...
    pub const STOP_MARKET: Self = Self(3);
    pub const STOP_LIMIT: Self = Self(4);
    ...
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            ...
            Self::STOP_MARKET => Some("STOP_MARKET"),
