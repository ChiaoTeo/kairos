...
pub mod kairos {
    ...
    pub mod market {
        ...
        pub mod v_1 {
            ...
            mod market_freshness_generated;
            pub use market_freshness_generated::*;
            mod instrument_status_generated;
            pub use instrument_status_generated::*;
            mod instrument_status_message_generated;
            pub use instrument_status_message_generated::*;
            mod rate_message_generated;
            pub use rate_message_generated::*;
            mod ticker_24h_message_generated;
            pub use ticker_24h_message_generated::*;
            mod mark_price_message_generated;
            pub use mark_price_message_generated::*;
            mod index_price_message_generated;
            pub use index_price_message_generated::*;
            mod funding_rate_message_generated;
            pub use funding_rate_message_generated::*;
            mod open_interest_message_generated;
            pub use open_interest_message_generated::*;
            mod trade_generated;
    ...
    pub mod risk {
        ...
        pub mod v_1 {
            ...
            mod authorize_risk_request_generated;
            pub use authorize_risk_request_generated::*;
