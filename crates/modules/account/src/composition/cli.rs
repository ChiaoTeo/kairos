...
use super::registry::{AccountBindingRecord, AccountCredentialBinding, AccountRegistry};
...
impl CliAccountApplication {
    ...
    pub async fn overview(
        ...
        let explicit_profile = if account.integration_provider.eq_ignore_ascii_case("binance") {
            ...
            {
                Some(true) => {
                    let profile = super::account::ObservedAccountProfile {
...
fn overview_profile(
    ...
    explicit_profile: Option<super::account::ObservedAccountProfile>,
