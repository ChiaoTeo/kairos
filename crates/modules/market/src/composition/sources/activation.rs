...
pub fn default_endpoint(provider: &str) -> &'static str {
    match provider {
        ...
        "binance-usdm-futures-websocket" => "wss://fstream.binance.com",
        ...
        "binance-options-websocket" => "wss://fstream.binance.com",
...
mod tests {
    ...
    #[test]
    fn routed_binance_products_use_a_base_endpoint() {
        assert_eq!(
            default_endpoint("binance-usdm-futures-websocket"),
