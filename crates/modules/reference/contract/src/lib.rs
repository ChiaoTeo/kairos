...
pub use control::{
    ...
    ReferenceControlRpcClient, ReferenceControlRpcServer, ReferenceCoverageRuntimeStatus,
    ReferenceDiagnostic, ReferenceDiagnosticSeverity, ReferenceHealthResponse,
    ReferenceHealthStatus, ReferenceMutationResponse, ReferenceOptionCoverageRequest,
