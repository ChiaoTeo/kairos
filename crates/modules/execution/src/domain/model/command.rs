...
pub struct IntentAdmissionEvidence {
    pub source: String,
    pub decision_id: kairos_primitives::risk::DecisionId,
    pub outcome: String,
...
impl ExecuteStrategyIntent {
    pub(crate) fn test_fixture() -> Self {
        Self {
            ...
            strategy_id: StrategyId::new("strategy:default").expect("valid fixture strategy ID"),
            launch_id: LaunchId::new("launch:default").expect("valid fixture launch ID"),
            instance_id: InstanceId::new("instance:default").expect("valid fixture instance ID"),
