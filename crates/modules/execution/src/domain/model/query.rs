//! Execution business queries and route candidates.
...
pub struct ExecutionRouteCandidate {
    ...
    pub instrument_id: Option<InstrumentId>,
    pub market_id: Option<MarketId>,
    pub broker_id: kairos_primitives::account::BrokerId,
    pub execution_channel: kairos_primitives::execution::ExecutionChannelCode,
    ...
    #[serde(default)]
    pub margin_rule_id: Option<kairos_primitives::risk::MarginRuleCode>,
}
