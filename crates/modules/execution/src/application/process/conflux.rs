...
use crate::domain::{
    ...
    ExecutionCommandKind, ExecutionOrderStatus, ExecutionRouteCandidate, OrderFactCursor,
    RemoteOrderUpdate, RouteSelectionKind, remote_status,
};
...
pub(in crate::application) struct ExecutionConfluxState {
...
impl ExecutionRpcActor for ExecutionApplication {
    ...
    async fn order_audit(
        ...
        let internal = crate::domain::ExecutionAuditQuery {
            order_id: query.order_id,
...
fn remote_order_event(
    ...
    let source_cursor = OrderFactCursor {
        connection_id: kairos_primitives::integration::IntegrationSourceId::new(
            envelope.connection_key.to_string(),
        )
        .expect("Conflux connection identity is valid"),
        channel_id: kairos_primitives::execution::ExecutionChannelCode::new(envelope.channel_id)
            .expect("Conflux execution channel identity is valid"),
        channel_epoch: envelope.channel_epoch.into(),
...
fn audit_event_response(
    value: crate::domain::ExecutionAuditEvent,
