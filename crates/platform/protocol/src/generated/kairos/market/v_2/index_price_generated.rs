...
impl<'a> IndexPrice<'a> {
    ...
    #[inline]
    pub fn spot_index_price(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(IndexPrice::VT_SPOT_INDEX_PRICE, None)
        }
    }
    #[inline]
    pub fn contract_index_price(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        // Safety:
        // Created from valid Table for this object
        // which contains a valid value in this slot
        unsafe {
    ...
    pub fn index_price(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        ...
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(IndexPrice::VT_INDEX_PRICE, None)
        }
    }
    #[inline]
    pub fn funding_rate(&self) -> Option<&'a super::super::common::v_2::Decimal64> {
        ...
        unsafe {
            self._tab
                .get::<super::super::common::v_2::Decimal64>(IndexPrice::VT_FUNDING_RATE, None)
        }
    }
    #[inline]
    pub fn source_observed_at_unix_nanos(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(IndexPrice::VT_SOURCE_OBSERVED_AT_UNIX_NANOS, Some(0))
                .unwrap()
        }
    }
    #[inline]
    pub fn received_at_unix_nanos(&self) -> u64 {
        ...
        unsafe {
            self._tab
                .get::<u64>(IndexPrice::VT_RECEIVED_AT_UNIX_NANOS, Some(0))
                .unwrap()
        }
    }
}
...
impl<'a: 'b, 'b, A: ::flatbuffers::Allocator + 'a> IndexPriceBuilder<'a, 'b, A> {
    ...
    pub fn add_spot_index_price(
        &mut self,
        spot_index_price: &super::super::common::v_2::Decimal64,
    ) {
        self.fbb_
    ...
    pub fn add_contract_index_price(
        &mut self,
        contract_index_price: &super::super::common::v_2::Decimal64,
    ) {
        self.fbb_
            .push_slot_always::<&super::super::common::v_2::Decimal64>(
                IndexPrice::VT_CONTRACT_INDEX_PRICE,
    ...
    pub fn add_source_observed_at_unix_nanos(&mut self, source_observed_at_unix_nanos: u64) {
        self.fbb_.push_slot::<u64>(
            IndexPrice::VT_SOURCE_OBSERVED_AT_UNIX_NANOS,
            source_observed_at_unix_nanos,
            0,
        );
    }
    ...
    pub fn add_received_at_unix_nanos(&mut self, received_at_unix_nanos: u64) {
        self.fbb_.push_slot::<u64>(
            IndexPrice::VT_RECEIVED_AT_UNIX_NANOS,
            received_at_unix_nanos,
            0,
        );
    }
