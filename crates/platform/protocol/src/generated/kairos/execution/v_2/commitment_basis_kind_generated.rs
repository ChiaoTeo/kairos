...
pub const ENUM_MIN_COMMITMENT_BASIS_KIND: u8 = 0;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
...
#[repr(transparent)]
pub struct CommitmentBasisKind(pub u8);
#[allow(non_upper_case_globals)]
impl CommitmentBasisKind {
    pub const UNSPECIFIED: Self = Self(0);
    pub const QUOTE_PRICE_CAP: Self = Self(1);
    ...
    pub fn variant_name(self) -> Option<&'static str> {
        match self {
            ...
            Self::QUOTE_PRICE_CAP => Some("QUOTE_PRICE_CAP"),
...
impl ::core::fmt::Debug for CommitmentBasisKind {
...
impl<'a> ::flatbuffers::Follow<'a> for CommitmentBasisKind {
    type Inner = Self;
    #[inline]
...
impl ::flatbuffers::Push for CommitmentBasisKind {
    type Output = CommitmentBasisKind;
    #[inline]
...
impl ::flatbuffers::EndianScalar for CommitmentBasisKind {
    type Scalar = u8;
    #[inline]
...
impl<'a> ::flatbuffers::Verifiable for CommitmentBasisKind {
    #[inline]
    fn run_verifier(
...
impl ::flatbuffers::SimpleToVerifyInSlice for CommitmentBasisKind {}
