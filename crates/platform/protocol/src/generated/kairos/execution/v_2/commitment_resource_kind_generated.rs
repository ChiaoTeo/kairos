...
pub const ENUM_MIN_COMMITMENT_RESOURCE_KIND: u8 = 0;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
...
#[repr(transparent)]
pub struct CommitmentResourceKind(pub u8);
#[allow(non_upper_case_globals)]
impl CommitmentResourceKind {
...
impl ::core::fmt::Debug for CommitmentResourceKind {
...
impl<'a> ::flatbuffers::Follow<'a> for CommitmentResourceKind {
    type Inner = Self;
    #[inline]
...
impl ::flatbuffers::Push for CommitmentResourceKind {
    type Output = CommitmentResourceKind;
    #[inline]
...
impl ::flatbuffers::EndianScalar for CommitmentResourceKind {
    type Scalar = u8;
    #[inline]
...
impl<'a> ::flatbuffers::Verifiable for CommitmentResourceKind {
    #[inline]
    fn run_verifier(
...
impl ::flatbuffers::SimpleToVerifyInSlice for CommitmentResourceKind {}
