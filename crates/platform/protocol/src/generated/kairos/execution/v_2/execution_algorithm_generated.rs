...
pub const ENUM_MIN_EXECUTION_ALGORITHM: u8 = 0;
#[deprecated(
    since = "2.0.0",
    note = "Use associated constants instead. This will no longer be generated in 2021."
)]
...
#[repr(transparent)]
pub struct ExecutionAlgorithm(pub u8);
...
impl ::core::fmt::Debug for ExecutionAlgorithm {
...
impl<'a> ::flatbuffers::Follow<'a> for ExecutionAlgorithm {
    type Inner = Self;
    #[inline]
...
impl ::flatbuffers::Push for ExecutionAlgorithm {
    type Output = ExecutionAlgorithm;
    #[inline]
...
impl ::flatbuffers::EndianScalar for ExecutionAlgorithm {
    type Scalar = u8;
    #[inline]
...
impl<'a> ::flatbuffers::Verifiable for ExecutionAlgorithm {
    #[inline]
    fn run_verifier(
...
impl ::flatbuffers::SimpleToVerifyInSlice for ExecutionAlgorithm {}
pub struct ExecutionAlgorithmUnionTableOffset {}
