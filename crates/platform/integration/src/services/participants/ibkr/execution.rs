//! Reusable IBKR session, order command, query, and stream mechanisms.
...
impl SessionService {
    ...
    pub(crate) async fn connect(&self) -> Result<(), IntegrationError> {
    ...
    pub(crate) async fn disconnect(&self) {
        ...
        *self.next_order_id.lock().await = None;
...
pub(crate) struct OrderCommandService {
...
impl OrderCommandService {
    pub(crate) async fn submit(
        ...
        let symbol = request.participant_instrument.source_symbol.as_str();
...
pub(crate) struct ExecutionStreamService {
    pub(crate) session: Arc<SessionService>,
    pub(crate) descriptor: ConnectionDescriptor,
    pub(crate) account_id: String,
