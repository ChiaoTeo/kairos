...
class FourProductSurfaceTests(unittest.TestCase):
    ...
    def test_strategy_model_code_contract_enters_strategy_lock(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            edited_model = strategy.set_model_code("model-code-strategy", model_file, metadata=model_metadata)
        ...
        self.assertTrue(started["target"]["workspace_source"].endswith("strategies/model-code-strategy/strategy.json"))
