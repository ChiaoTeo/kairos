...
from kairospy.execution import build_execution_calibration_release, load_execution_calibration_release
    ...
    def test_runtime_calibration_cli(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            completed = subprocess.run(
                [sys.executable, "-m", "kairospy", "runtime", "calibrate-execution",
