...
from trading.adapters.massive import MassiveClient, MassiveConfig, MassiveFlatFileBatchDownloader, MassiveFlatFileClient, MassiveResponse, MassiveSourceArchive, OutsideDownloadWindow
from trading.adapters.massive.client import MassiveError
...
class MassiveAdapterTests(unittest.TestCase):
    ...
    def test_source_archive_is_idempotent_and_does_not_persist_key(self):
        ...
        with TemporaryDirectory() as temporary:
            archive = MassiveSourceArchive(temporary, client, now=lambda: datetime(2026, 7, 15, tzinfo=timezone.utc))
    ...
    def test_non_https_and_incomplete_source_cache_is_quarantined(self):
        with TemporaryDirectory() as temporary:
            ...
            moved = MassiveSourceArchive.quarantine_non_https(temporary)
