...
class MassiveNotebookTests(unittest.TestCase):
    def test_notebooks_are_valid_offline_readers_with_unique_cell_ids(self):
        for name in ("massive_data_quality.ipynb", "massive_research_readiness.ipynb", "spxw_popular_options_2026.ipynb", "nvda_options_2026.ipynb"):
            ...
            if name == "massive_research_readiness.ipynb":
