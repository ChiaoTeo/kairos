...
from trading.adapters.massive import MassiveEquityDayAggPipeline, SpxwDayAggPipeline
from trading.adapters.massive.source import MassiveFlatFileBatchDownloader, request_fingerprint
from trading.data import DataCatalog, DatasetQualityService, QualityLevel, ResearchDataClient
...
class MassiveDayAggTests(unittest.TestCase):
    ...
    def test_equity_day_aggs_preserve_raw_and_vendor_adjusted_views(self):
        with TemporaryDirectory() as temporary:
            root = Path(temporary)
