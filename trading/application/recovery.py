...
from trading.accounting.portfolio import PortfolioSnapshot, Portfolio
from trading.adapters.base import AccountAdapter
...
class RuntimeRecoveryService:
    ...
    def __init__(
        ...
        account_adapters: Mapping[AccountKey, AccountAdapter],
        *,
        ...
        self.account_adapters = dict(account_adapters)
        self.marks = marks
    ...
    def recover(self, at: datetime) -> RuntimeRecoveryResult:
        ...
        reports = tuple(
            ...
            for account, adapter in sorted(self.account_adapters.items(), key=lambda item: item[0].value)
        )
        reasons = []
