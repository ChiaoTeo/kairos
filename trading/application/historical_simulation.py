...
from trading.contracts import BarPayload, CanonicalEventEnvelope
...
from trading.domain.intent import CancelIntent, TargetExposureIntent
...
from trading.execution.strategy_planner import plan_economic_intent
...
class _SmaSimulationHooks:
    def __init__(self, *, clock: FixedClock, store: SQLiteRuntimeStore, catalog: ReferenceCatalog,
                 ...
                 venue: SimulatedExecutionAccountAdapter) -> None:
...
async def run_sma_historical_simulation(
    *, root: str | Path, events: tuple[CanonicalEventEnvelope, ...], catalog: ReferenceCatalog,
    ...
    venue = SimulatedExecutionAccountAdapter(
