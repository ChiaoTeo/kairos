...
if TYPE_CHECKING:
    from trading.execution.recovery import OrderRecoveryReport, VenueOrderRecoveryService
...
class TradingApplication:
    """Lifecycle and recovery gate for a single-account-set trading runtime."""
