...
from trading.features.runtime import FactorRuntime, FactorSnapshot
from trading.execution.intent_status import IntentExecutionTracker
...
from trading.strategies.runtime import GovernedStrategyRuntime
...
class StrategyRunHooks(Protocol):
    def before_decision(
        self, event: CanonicalEventEnvelope, market: MarketSlice, factor: FactorSnapshot,
    ) -> None: ...
...
class CanonicalBarMarketProjection:
    ...
    def apply(self, event: CanonicalEventEnvelope) -> MarketSlice | None:
...
class GovernedStrategyRunLoop:
    ...
    def __init__(
        ...
        context_factory: Callable[[MarketSlice], StrategyContext],
        *,
