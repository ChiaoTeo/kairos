...
from trading.storage.data_lake import (
...
class DeribitDvolDatasetConnector:
    ...
    def acquire(self, request: AcquisitionRequest) -> DatasetRelease:
        ...
        return publish_release(
            ...
            transform_id="deribit.dvol.daily", transform_version="2", quality_level=QualityLevel.RESEARCH,
        )
...
class DeribitOptionTradesDatasetConnector:
    ...
    def acquire(self, request: AcquisitionRequest) -> DatasetRelease:
        ...
        return publish_release(
            ...
            transform_id="deribit.option_trades", transform_version="2", quality_level=QualityLevel.RESEARCH,
        )
...
class DeribitOptionSnapshotDatasetConnector:
    ...
    def acquire(self, request: AcquisitionRequest) -> DatasetRelease:
        ...
        return publish_release(
            ...
            transform_id="deribit.option_chain.snapshot", transform_version="2", quality_level=QualityLevel.RESEARCH,
        )
