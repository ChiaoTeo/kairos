...
from trading.reference import MappingTargetType, ProviderId, ProviderSymbolMapping
...
class MassiveEquityIdentityResolver:
    ...
    def save(self, result: MassiveEquityIdentityResult, root: str | Path, *, name: str = "equity_identity") -> dict[str, object]:
        ...
        if name == "equity_identity":
            ...
            from trading.data.models import DatasetRelease, DatasetStatus, DatasetStorageKind, QualityLevel
