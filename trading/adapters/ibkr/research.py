...
class IbkrSpxwResearchAdapter:
    """IBKR research adapter that exposes only normalized definitions and events."""

    venue_id = VenueId("ibkr")

    def __init__(self, spec: ResearchSpec, *, host: str = "127.0.0.1", port: int = 4001, client_id: int = 21, readonly: bool = True) -> None:
