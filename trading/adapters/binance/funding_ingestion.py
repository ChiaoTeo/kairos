...
from .adapter import BinanceFundingAdapter
...
class BinanceDurableFundingBackfill:
    ...
    def __init__(
        self, account: AccountKey, adapter: BinanceFundingAdapter,
        ...
        self.account, self.adapter, self.ingestion = account, adapter, ingestion
    ...
    def backfill(self) -> FundingBackfillReport:
        ...
        payments = self.adapter.funding_history(self.account, start, end)
