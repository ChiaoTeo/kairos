...
from trading.data import (
    DataCatalog, DatasetKey, DatasetLayer, DatasetProduct, DatasetProductSpec, DatasetStorageKind,
    QualityLevel, SourceBinding,
)
from trading.data.publishing import publish_release, release_path
from trading.domain.identity import InstrumentId
from trading.domain.market_data import Bar
from trading.storage.data_lake import write_intraday_dataset


SMA_TUTORIAL_RELEASE_ID = "fixture:sma-bars-v1"

SMA_TUTORIAL_DATASET = DatasetProductSpec(
    DatasetProduct(
...
def ensure_sma_tutorial_dataset(root: str | Path):
    ...
    lineage = {
        ...
        "producer": {"name": "trading.research.tutorial_data", "version": "1"},
