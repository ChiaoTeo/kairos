...
class SeriesCaptureService:
    ...
    def capture(self, provider: SpxwResearchProvider, research: ResearchSpec, series: SeriesCaptureSpec, *, append: bool = False) -> HistoricalDataset:
        ...
        try:
            ...
            for index in range(series.sample_count):
                ...
                market_slice = MarketSlice(timestamp, tuple(snapshots), ((underlying.instrument_id, slice_price),), tuple(issues), span, index, universe)
