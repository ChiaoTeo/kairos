...
class ResearchResult:
    ...
    def columns(self) -> tuple[str, ...]:
        return tuple(field.name for field in fields(ResearchRow))
...
def analyze(snapshot: ResearchSnapshot) -> ResearchResult:
    ...
    grouped: dict[tuple[str, Decimal], dict[str, ResearchRow]] = {}
    for row in rows:
