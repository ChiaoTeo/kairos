...
_TEXT = {
    "zh-CN": {
        ...
        "run.backtest": "策略回测完成",
        "run.backtest-sma": "SMA 回测完成",
        "run.simulate-sma": "SMA 历史仿真完成",
        "run.paper-sma": "SMA Paper Session 完成",
        "run.shadow-sma": "SMA Shadow Session 完成",
        "run.inspect": "运行详情",
        "run.replay-sma": "SMA 重放验证 {status}",
        "run.replay-sma-capture": "SMA Capture 重放验证 {status}",
    ...
    "en-US": {
        "tutorial.sma": "SMA research tutorial is ready",
        ...
        "study.scaffold": "Research script generated",
        ...
        "run.backtest-sma": "SMA backtest completed",
        "run.simulate-sma": "SMA historical simulation completed",
        "run.paper-sma": "SMA paper session completed",
        "run.shadow-sma": "SMA shadow session completed",
        "run.inspect": "Run details",
        "run.replay-sma": "SMA replay validation {status}",
        "run.replay-sma-capture": "SMA capture replay validation {status}",
        ...
        "replay_meaning": "Batch research and event replay agree. You may continue; this does not mean the strategy is profitable.",
...
_LABELS = {
    ...
    "en-US": {
        ...
        "script": "Research script", "shown": "Rows shown", "total": "Total rows", "rows": "Rows", "columns": "Columns",
...
def render_product_result(group: str, action: str, payload: Mapping[str, object], language: str) -> str:
    ...
    if group == "tutorial":
        ...
        sections = (
            ("section.result", ("mode", "passed", "bars", "trades", "orders", "fills", "final_equity",
