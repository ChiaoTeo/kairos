...
from trading.contracts import CanonicalEventEnvelope, MarketEventKind, QuotePayload
...
class CanonicalQuoteSliceProjection:
    """Build point-in-time MarketSlice values shared by live and replay StrategyContext."""
