...
class OptionSkewFactorRuntime:
    ...
    def __init__(self,catalog:ReferenceCatalog,config:OptionSkewFactorConfig=OptionSkewFactorConfig(),*,
        ...
        self._spec=FactorSpec(factor_id,version,("market_slice.option_quotes","internal.option_valuation"),
            ...
            "trading.features.option_skew:OptionSkewFactorRuntime",implementation_hash(Path(__file__)))

    @property
    def spec(self):return self._spec
    def snapshot(self):return self._snapshot

    def update_market(self,market:MarketSlice,valuation:ValuationSnapshot)->FactorSnapshot|None:
        candidates=[]
...
class OptionFearCoolingFactorRuntime:
    """Governed adapter for IV percentile, put skew and IV cooling used by iron condors."""
    def __init__(self,catalog:ReferenceCatalog,*,input_identity:str,factor_id="option-fear-cooling",version="1.0.0"):
        ...
        self._spec=FactorSpec(factor_id,version,("internal.option_valuation",),(('history','expanding'),),2,
            ...
            "trading.features.option_skew:OptionFearCoolingFactorRuntime",implementation_hash(Path(__file__)))
    @property
    def spec(self):return self._spec
    def snapshot(self):return self._snapshot
    def update_market(self,market:MarketSlice,valuation:ValuationSnapshot):
