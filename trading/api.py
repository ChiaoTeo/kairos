...
from trading.product_workflow import inspect_run, run_sma_backtest_workflow
...
class BacktestRunner:
    ...
    def run(self, request: BacktestRequest) -> BacktestResultView:
        ...
        if strategy_id != "sma-cross-v1":
            raise ValueError(f"Trader.backtest currently supports sma-cross-v1, got {request.strategy!r}")
