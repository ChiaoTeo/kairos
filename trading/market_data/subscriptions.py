...
from trading.reference.access import definition_at, product_type
from trading.reference.models import MappingTargetType
    ...
    def build(self, requirements: tuple[MarketDataRequirement, ...], at: datetime) -> SubscriptionPlan:
        ...
        for requirement in requirements:
            ...
            if capabilities is None:
                raise LookupError(f"no market-data adapter registered for venue {requirement.venue_id}")
