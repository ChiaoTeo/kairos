...
def cost_of_carry_forward(spot: Decimal, maturity_years: Decimal, rate: Decimal, dividend_yield: Decimal = Decimal("0")) -> Decimal:
...
def parity_forward(call_price: Decimal, put_price: Decimal, strike: Decimal, maturity_years: Decimal, rate: Decimal) -> Decimal:
