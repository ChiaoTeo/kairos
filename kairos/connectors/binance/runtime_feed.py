...
from kairos.application import RuntimeFeedPlan, RuntimeFeedServiceBundle, RuntimeFeedServicePlan
...
from kairos.market_data import BoundedEventChannel, RotatingCanonicalCaptureWriter
...
def _binance_stream_config(
    ...
    return {
        ...
        "source_instance": str(source.get("source_instance") or f"kairos-runtime:{service.name}"),
