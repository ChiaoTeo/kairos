...
def default_provider_registry(root: str | Path = "data", *, connector_config: str | Path | None = None,
    ...
    if connector_config is not None:
        from kairos.connectors.massive.datasets import MassiveEquityDailyOhlcvProductConfig, MassiveOptionProductConfig
...
class _ConfiguredMassiveConnector:
    ...
    def estimate(self, request):
        from kairos.data.acquisition import AcquisitionEstimate
