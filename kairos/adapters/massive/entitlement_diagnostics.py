...
class MassiveEntitlementReport:
    ready: bool
    api_host: str
...
class MassiveEntitlementDiagnostics:
    def __init__(self, client: MassiveClient) -> None:
        self.client = client

    def check(self, *, underlying: str, option_ticker: str, date: str) -> MassiveEntitlementReport:
        ...
        return MassiveEntitlementReport(ready, "https://api.massiveprivateserver.site", checks, official, mode)
