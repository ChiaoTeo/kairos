...
from kairos.domain.market_data import DerivativeMarketState, OrderBookDelta, OrderBookSnapshot, Quote, Trade
...
def canonicalize_market_event(event, *, source_instance: str = "default") -> CanonicalEventEnvelope:
    ...
    message_id = uuid5(NAMESPACE_URL, "kairos:canonical-market-event:" + sha256(encoded).hexdigest())
...
def _canonical(
    ...
    message_id = uuid5(NAMESPACE_URL, "kairos:canonical-live-market-event:" + sha256(encoded).hexdigest())
    return CanonicalEventEnvelope(
