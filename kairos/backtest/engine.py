...
from kairos.domain.intent import CloseStructureIntent, LegIntent
...
from kairos.risk.scenarios import RevaluationPosition, ScenarioEngine, standard_scenario_grid
from kairos.storage.codec import to_primitive
from kairos.strategies.strategy_protocols import Strategy, StrategyContext
