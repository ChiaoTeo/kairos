...
from kairos.domain.intent import CloseStructureIntent, Intent
from kairos.domain.order import Order, OrderStatus
from kairos.domain.product import is_option_spec
