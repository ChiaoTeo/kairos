...
from kairos.domain.market_data import Bar, OrderBookSnapshot, Quote, TradingState, TradingStatus
from kairos.domain.order import Fill, LegFill, Order, OrderStatus, TimeInForce
...
class ListedOptionComboFillModel:
    ...
    def attempt(self, order: Order, market: MarketSnapshot) -> FillAttempt:
