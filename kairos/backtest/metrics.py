...
from kairos.domain.order import Fill, Order, OrderStatus, Settlement
...
def calculate_metrics(
    ...
    grouped_dte, grouped_hour, grouped_iv = _trade_groups(fills, settlements, completed_ids, market_snapshots, catalog)
    max_greeks = {}
...
def _trade_groups(fills, settlements, completed_ids, market_snapshots, catalog):
    ...
    markets = {item.timestamp: item for item in market_snapshots}
