...
from kairos.data.publishing import publish_release, release_path
from kairos.domain.identity import InstrumentId
from kairos.domain.market_data import Bar
from kairos.storage.data_lake import write_intraday_dataset
...
def ensure_sma_tutorial_dataset(root: str | Path):
    ...
    lineage = {
        ...
        "producer": {"name": "kairos.study_platform.tutorial_data", "version": "1"},
