...
_MAXIMUM_CLAIMS = {
    ValidationLevel.L1_DATA: "data can support the registered experiment question",
...
def authorize_claim(result: ExperimentValidationResult, requested_level: ValidationLevel, *,
