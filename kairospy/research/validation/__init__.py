"""Governed validation contracts and gates."""
...
__all__ = [
    ...
    "ExecutionArchetype", "GateDecision", "GateRequirement", "OutOfSampleEvidence",
    "PredictabilityResult", "ProductProtocol", "ProtocolDecision", "ExperimentValidationResult", "ReturnDriver", "RobustnessResult", "SampleSufficiency",
    "ExperimentRegistration", "TestWindowRegistry", "TestWindowUse", "TimeSplit", "ValidationArtifactWriter", "ValidationGate", "ValidationLevel",
    "ValidationState", "assess_sample_sufficiency", "approximate_required_samples",
