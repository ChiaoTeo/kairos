...
from kairospy.reference.contracts import ExerciseStyle, ListedOptionSpec, ProductType, SettlementSession, SettlementType

from .spec import OptionChainCaptureSpec
from kairospy.reference import ListingDefinition, ListingId, ReferenceCatalog, TradingRules
...
def select_instruments(catalog: ReferenceCatalog, chain: OptionChain, spot: Decimal, spec: OptionChainCaptureSpec) -> tuple[InstrumentDefinition, ...]:
