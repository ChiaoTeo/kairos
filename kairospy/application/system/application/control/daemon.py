...
from kairospy.application.support.launch.application.launcher import LaunchTarget, LaunchTargetDescriptor, TradingConfigurationError, TradingSystemLauncher
from kairospy.application.support.system.application.session import SystemCommand, SystemCommandDispatcher, SystemCommandFileQueue
from kairospy.application.support.system.domain.config import RESERVED_LAUNCH_IDS, SYSTEM_LAUNCH_ID
    ...
    def launch_foreground(
        ...
        *,
        ...
        try:
            ...
            target.bind_stop(lambda: _control_stop_requested(directory))
...
class _LaunchTargetResolver:
    ...
    def describe(self, mode: RuntimeMode, config_path: Path) -> LaunchTargetDescriptor:
        return self.launcher.describe_target(mode=mode, config_path=config_path)
    ...
    def resolve(
        ...
        *,
        ...
        try:
            return self.launcher.resolve_target(
                mode=mode,
