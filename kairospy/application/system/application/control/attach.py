...
from kairospy.application.support.system.application.control.facade import LaunchFacade, record_payload
...
class LaunchAttachSession:
    def __init__(self, target: AttachTarget, *, launches: LaunchFacade | None = None) -> None:
        self.target = target
    ...
    def resolve(
        ...
        *,
        ...
        facade = launches or LaunchFacade()
