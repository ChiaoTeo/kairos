...
from kairospy.domain.reference.identity import AssetId, InstrumentId, ListingId, MarketId, reference_slug
...
@dataclass(frozen=True, slots=True)
class ReferenceSnapshotBuilderService:
    def from_market_rows(self, rows: Iterable[Mapping[str, object]], *, effective_from: datetime) -> ReferenceCatalog:
        return catalog_from_market_rows(rows, effective_from=effective_from)

    def from_equity_rows(self, rows: Iterable[Mapping[str, object]], *, effective_from: datetime) -> ReferenceCatalog:
    ...
    def from_reference_rows(
        ...
        *,
        ...
        return catalog_from_reference_rows(rows, effective_from=effective_from, product=product)
