...
from kairospy.application.usecases.execution.domain.result import SimulatedFill, SimulatedClosedTrade
from kairospy.domain.account import EquityCurvePoint
...
def equity_point_from_account_view(time: datetime | None, account_view: object | None) -> EquityCurvePoint | None:
...
def _max_drawdown(equity_curve: tuple[EquityCurvePoint, ...]) -> tuple[Decimal, Decimal]:
