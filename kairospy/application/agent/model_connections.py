...
from kairospy.application.workspace.transaction import WorkspaceConfigurationTransaction
...
class ModelProviderConnectionApplication:
            ...
            result.append(
                {
                    ...
                    "input": list(value.get("input") or ("text",)),
    ...
    def _configuration_hash(self, connection: Mapping[str, object]) -> str:
        ...
        payload: dict[str, object] = {
            ...
            "models": list(connection.get("models") or ()),
...
def _discover_models(
    ...
    timeout = float(connection.get("timeout_seconds") or 60.0)
...
def _model_connection_document(connection: Mapping[str, object]) -> str:
    models = tuple(str(value) for value in connection.get("models") or ())
    lines = [
        "[connection]",
        "version = 1",
        ...
        f"timeout_seconds = {float(connection.get('timeout_seconds') or 60.0)}",
