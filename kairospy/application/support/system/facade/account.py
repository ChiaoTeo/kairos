...
from kairospy.application.support.system.workspace import AccountRecord, write_credential_file
from kairospy.config import ConfigError
from kairospy.core.account import AccountBookKind, AccountBookRef
from kairospy.application.support.system.pagination import PageRequest, paginate
    ...
    def balance(
        ...
        *,
        ...
        for index, book in enumerate(selected_books, start=1):
            ...
            route = configured_account_book_route(book_ref, broker=account.broker, base_params=params)
            if progress is not None:
