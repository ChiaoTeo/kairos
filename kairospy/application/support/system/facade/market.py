...
from kairospy.application.usecases.market import MarketDataOperationsService, MarketDataResolver, MarketDataSpec, parse_market_dataset_id, replay_rows
from kairospy.application.support.launch.composition.backtest import backtest_market_data_service
from kairospy.application.support.launch.config.backtest import BacktestConfigurationError, configured_backtest
from kairospy.application.support.launch.composition.resources import DriverName, ExchangeName, StorageFormat, data_store, exchange
...
from kairospy.core.market import Bar, MarketSelector
        ...
        *,
        ...
        for subscription in subscriptions:
            for spec in _historical_specs(
                ...
                path = None if dry_run else data.download(spec, exchange(exchange_name, driver_name), mode=mode)
                downloads.append(
                    {
