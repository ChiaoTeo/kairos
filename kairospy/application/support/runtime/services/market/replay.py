...
from kairospy.application.usecases.market.datasets import MarketDatasetStore
from kairospy.application.usecases.market.subscriptions import DataSubscription, MarketDataSubscriptionSpec
from kairospy.application.support.runtime.contracts import MarketRuntime, MarketRuntimeEnvelope
from kairospy.application.usecases.market import MarketDataOperationsService, MarketDataResolver, MarketDataSpec
from kairospy.application.usecases.market.datasets import parse_market_dataset_id
from kairospy.application.usecases.market.sources import IterableMarketEventSource, market_event_from_row, parse_event_time
...
class HistoricalClientFactory(Protocol):
    def __call__(self, spec: MarketDataSpec) -> HistoricalMarketDataPort:
        ...
