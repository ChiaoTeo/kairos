...
class MarketWatch(Protocol):
    def __call__(self, feed: MarketStreamGateway) -> AsyncIterator[MarketEvent]:
        ...
...
class StreamingMarketDataService(MarketSubscriptionState, MarketRuntime):
    def __init__(
        ...
        *,
        ...
        self._sequence = 0
        self._stop_requested: StopRequested | None = None
    ...
    def set_stop_requested(self, stop_requested: StopRequested | None) -> None:
