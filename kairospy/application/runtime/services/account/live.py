...
from kairospy.application.protocol import RuntimeEnvelope, RuntimeIncident
from kairospy.application.runtime.connections import ConnectionManager
from kairospy.application.runtime.contracts import AccountCatalog, AccountRuntime, AccountRuntimeEnvelope
from kairospy.application.domain.account.bootstrap import bootstrap_account
from kairospy.application.domain.account.bootstrap import AccountBootstrapGateway, AccountBootstrapParser
from kairospy.application.domain.account.routing import AccountBookRoute, account_book_route
from kairospy.application.domain.account.live_stream import (
...
class LiveAccountService(AccountRuntime, AccountCatalog):
    def __init__(
        ...
        *,
        ...
        broker_resolver: Callable[[AccountBookRef], AccountBootstrapGateway | None] | None = None,
        ...
        stream_resolver: Callable[[AccountBookRef], LiveAccountStreamGateway | None] | None = None,
