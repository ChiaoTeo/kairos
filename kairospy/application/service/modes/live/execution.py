...
from kairospy.application.service.domain.execution import execution_coordinator_components
    ...
    def on_intents(self, intents: tuple[object, ...], context: object, hook: str) -> None:
        ...
        for intent in intents:
            if isinstance(intent, TradeIntent):
                adapter.execute_intent(intent, context, order_params=self.order_params)  # type: ignore[arg-type]
