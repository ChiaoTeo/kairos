...
from kairospy.application.service.domains.execution import BasisPointSlippageModel, ImmediateFillModel
...
from kairospy.application.service.domains.market import MarketDataResolver, MarketDataService
...
def _primary_backtest_subscription(subscriptions: tuple[MarketSubscription, ...]) -> MarketSubscription:
    bar_subscriptions = [
        ...
        if any(selector.model.__name__ == "Bar" for selector in subscription.spec.selectors)
    ]
