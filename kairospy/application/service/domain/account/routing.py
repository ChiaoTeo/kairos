...
from kairospy.core.account import AccountBookKind, AccountRef
...
def account_book_route(book: AccountRef, *, provider: str | None = None, base_params: Mapping[str, object] | None = None) -> AccountBookRoute:
...
def account_book_routes(books: tuple[AccountRef, ...], *, provider: str | None = None) -> tuple[AccountBookRoute, ...]:
