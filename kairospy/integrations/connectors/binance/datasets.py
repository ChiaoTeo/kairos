...
from kairospy.data.http import download
...
from kairospy.data.publishing import (
    content_release_id, content_release_id_from_rows, merge_release_rows, publish_release, release_path,
)
from kairospy.infrastructure.storage.data_lake import utc_midnight, write_daily_dataset, write_intraday_dataset, write_json
...
class BinanceOptionQuotesDatasetConnector:
    ...
    def acquire(self, request: AcquisitionRequest) -> DatasetRelease:
        ...
        return publish_release(
            ...
            transform_id="binance.option_eoh.quotes", transform_version="2", quality_level=QualityLevel.WORKSPACE,
        )
