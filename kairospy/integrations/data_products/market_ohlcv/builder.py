...
from kairospy.integrations.acquisition.evidence import acquisition_request_evidence, request_windows_evidence, universe_evidence
...
class EquityOhlcvDataProductBuilder:
    ...
    def acquire(self, request: object) -> DatasetRelease:
        raise RuntimeError("release publishing has been removed; use integration-provided Data Product ingestion backed by DatasetWriter")
