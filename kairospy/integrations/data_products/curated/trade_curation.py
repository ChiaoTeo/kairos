...
from kairospy.data.contracts import DatasetRelease, DatasetStatus, QualityLevel
...
def curate_sorted_trade_release(root: str | Path, source_release_id: str) -> DatasetRelease:
    ...
    if spec.quality_profile != "trade":
        raise ValueError("sorted Trade curation requires the trade data product contract profile")
