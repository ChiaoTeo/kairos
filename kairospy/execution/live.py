...
from kairospy.accounts import AccountContext, AccountSnapshot
from kairospy.intents import IntentEvent, IntentEventKind, IntentKind, TradeIntent
from kairospy.orders import OrderRequest, OrderSide, OrderType
...
class LiveExecutionAdapter:
    ...
    def _record_intent_event(
        ...
        *,
        ...
        context.intents.record(IntentEvent(intent.intent_id, kind, context.now or datetime.now(timezone.utc), order_ids, reason))
