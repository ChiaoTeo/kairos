...
from .model import Bar, OrderBookSnapshot, PriceLevel, Quote, TradePrint
...
def trade_print_record(trade: TradePrint, *, venue: str, market: str, source_symbol: str) -> dict[str, object]:
...
def bar_record(bar: Bar, *, venue: str, market: str, source_symbol: str) -> dict[str, object]:
...
def event_time(value: object | None) -> datetime:
