...
class Instrument(Protocol):
    ...
    @property
    def primary_currency_asset_id(self) -> str | None: ...
...
class TradingRules(Protocol):
    @property
    def price_increment(self) -> Decimal | None: ...

    @property
    def quantity_increment(self) -> Decimal | None: ...

    @property
    def minimum_quantity(self) -> Decimal | None: ...

    @property
    def minimum_notional(self) -> Decimal | None: ...

    @property
    def contract_multiplier(self) -> Decimal | None: ...
