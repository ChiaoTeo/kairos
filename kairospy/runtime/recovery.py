...
from kairospy.portfolio.accounting.conversion import AssetConversionGraph
from kairospy.portfolio.accounting.portfolio import PortfolioSnapshot, Portfolio
...
from kairospy.reference.contracts import FutureSpec, is_option_spec
...
class RuntimeRecoveryService:
    ...
    def __init__(
        ...
        account_gateways: Mapping[AccountRef, AccountPort],
        *,
