...
from kairospy.core.reference.products import (
    ...
    currency_asset_id as product_currency_asset_id,
    equity_asset_id,
...
def catalog_from_equity_rows(rows: Iterable[Mapping[str, object]], *, effective_from: datetime) -> ReferenceCatalog:
    ...
    for row in rows:
        ...
        currency_asset_id = product_currency_asset_id(currency)
...
def _instrument_type(value: object) -> InstrumentType:
    return instrument_product_for_market(value).instrument_type
