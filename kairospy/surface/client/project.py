...
from ...application.workspace import Workspace, WorkspaceApplication
from .data import DataClient

if TYPE_CHECKING:
    from ...application.launch.application.configuration import LaunchConfig, LaunchPlan
...
class Kairos:
    ...
    def launch_config(self, value: str | Path | LaunchConfig) -> LaunchConfig:
        ...
        from ...application.launch.application.configuration import (
            LaunchConfig,
    ...
    def launch_instances(
        ...
        from ...application.launch.application.registry import LaunchRegistryApplication
    ...
    async def start_launch(
        ...
        *,
        ...
        from ...application.launch.application.runtime import LaunchRuntimeApplication
    ...
    async def run_backtest(
        ...
        *,
        ...
        from ...application.launch.application.backtests import BacktestApplication
