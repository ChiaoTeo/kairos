...
from .activity import ActivityOutcome, ActivityRecord
from .effects import (
    AppendActivity,
...
from .command_line_support import (
    activity_kind as _activity_kind,
    help_table as _help_table,
    parse_command as _parse_command,
    running_status as _running_status,
    shell_result_body as _shell_result_body,
    value_or_unknown,
)
