...
from .configuration_support import (
    ...
    _account_access_summary,
    _account_credential_actions,
    _credential_actions,
    _data_product_actions,
    _model_endpoint_actions,
    _model_provider_actions,
    _workspace_owner,
)
...
def handle_success(
    ...
    if kind is ResultKind.RESOURCE_WIZARD:
        ...
        connection_id = _saved_connection_id(result, wizard)
        ...
        if (
            ...
            if plan is not None and connection_id:
                session.market.catalog_setup_plan = plan.with_connection_id(
                    connection_id
                )
                plan = session.market.catalog_setup_plan
