...
class TreasuryLedgerPostingService:
    """Posts confirmed transfer facts; it does not submit external transfers."""

    def __init__(self, ledger: Ledger, controlled_accounts: dict[LocationId, AccountRef], transit_account: AccountRef) -> None:
        self.ledger = ledger
    ...
    def _account(self, location: LocationId) -> AccountRef:
        try:
