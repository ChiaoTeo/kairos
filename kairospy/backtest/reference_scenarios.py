...
from kairospy.backtest.fill import CryptoOrderBookFillModel, EquityTopOfBookFillModel, SingleAssetOrder, StressWrapperFillModel
...
from kairospy.domain.market_data import OrderBookLevel, OrderBookSnapshot, Quote
...
from kairospy.domain.corporate_action import CashDividendEvent
...
def _slice(at,values):
    ...
    return MarketSnapshot(at,snapshots,sequence=1,available_instruments=tuple(item[0] for item in values))
