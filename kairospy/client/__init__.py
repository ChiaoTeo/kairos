...
if TYPE_CHECKING:
    from kairospy.system.apps.launch.application.semantics import OptionBacktestConstraints
...
def __getattr__(name: str) -> Any:
    if name in {"BacktestResult", "BacktestSpec"}:
        from kairospy.system.apps.launch.application.specs import (
            BacktestResult,
            BacktestSpec,
        )
    ...
    if name == "OptionBacktestConstraints":
        from kairospy.system.apps.launch.application.semantics import (
