...
from kairospy.governance.events import DataWarningRaised
from kairospy.identity import AccountRef, InstitutionId, InstrumentId
from kairospy.integrations.events import BrokerConnected, BrokerDisconnected
from kairospy.market.events import EventEnvelope, GreeksUpdated, OptionChainDiscovered, QuoteUpdated, TradeUpdated, UnderlyingPriceUpdated
from kairospy.market.slices import DataQualityIssue, InstrumentSnapshot
from kairospy.market.types import FundingRate, Greeks, IndexPrice, MarkPrice, OpenInterest, OptionChain, Quote, Trade, TradingStatus, VolatilitySurfacePoint
from kairospy.research.capture.snapshot import OptionCaptureSnapshot
...
def snapshot_from_primitive(value: dict[str, Any]) -> OptionCaptureSnapshot:
    from kairospy.reference.repository import instrument_from_primitive
