...
from kairospy.domain.market.model import Bar, OptionGreeks, Quote, RateObservation, TradePrint
from kairospy.domain.market.orderbook import OrderBookSnapshot, PriceLevel
...
def bar_to_record(bar: Bar, *, market: MarketRef) -> BarRecord:
    return bar_record(
        bar,
...
def funding_rate_to_record(rate: RateObservation, *, market: MarketRef) -> RateRecord:
