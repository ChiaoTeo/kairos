...
_EVENT_ROOTS: tuple[tuple[bytes, str], ...] = (
    ...
    (b"RFPU", "FinancialProductUpserted"),
    (b"RFPD", "FinancialProductUpdated"),
    (b"RAU2", "AssetUpserted"),
    (b"RAD2", "AssetUpdated"),
    (b"REU2", "ExchangeUpserted"),
    (b"RED2", "ExchangeUpdated"),
    (b"RPU2", "ProviderUpserted"),
    (b"RPD2", "ProviderUpdated"),
    (b"RBU2", "BrokerUpserted"),
    (b"RBD2", "BrokerUpdated"),
    (b"RXU2", "ExecutionAccessUpserted"),
    (b"RXD2", "ExecutionAccessUpdated"),
    (b"RMDA", "MarketDataAccessUpserted"),
    (b"RMDD", "MarketDataAccessUpdated"),
