...
from kairospy.application.capital.events import CapitalEventRecord
from kairospy.infrastructure.contracts.capital import decode_event
from kairospy.infrastructure.transport.generated_spec import CAPITAL_EVENTS, DEFAULT_CHANNEL
