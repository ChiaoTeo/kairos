...
class ConnectionService(IntegrationConnection):
    ...
    def __post_init__(self) -> None:
        identity = ConnectionIdentity(
            ...
            participants=(self.spec.participant,),
        )
        self._state = ConnectionState(identity=identity, bindings=(self.spec.binding,))
...
__all__ = ["CompositeConnectionComponent", "ConnectionComponent", "ConnectionService"]
