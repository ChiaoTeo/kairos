...
class BinanceEquityPollingConnection(Connection):
    ...
    async def subscribe(self, request: MarketFeedSubscriptionRequest) -> "BinanceEquityQuoteSubscription":
...
class BinanceEquityQuoteSubscription:
    def __init__(self, *, subscription_id: str, symbol: str, market: object, operations: BinanceEquityMarketOperations, normalizers: BinanceEquityNormalizers, poll_seconds: float) -> None:
