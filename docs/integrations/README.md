...
这里保存 Integration 当前能力和可复核证据，而不是未来 endpoint 清单或日常实施计划。
业务可用性必须区分局部实现、组合路径、fixture 证据和 live 认证。
...
- [Binance capital products](binance-capital-products.md)
- [Massive Forex and Crypto](massive-currencies-adapter.md)
- [Massive Futures](massive-futures-adapter.md)
- [Massive Indices](massive-indices-adapter.md)
- [Massive options snapshot](massive-options-snapshot.md)
