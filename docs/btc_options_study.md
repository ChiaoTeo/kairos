...
python3 -m kairospy data acquire \
  --dataset derivatives.option_trades.crypto.deribit.btc \
  --provider deribit --venue deribit \
  --start 2021-01-01T00:00:00+00:00 --end 2026-07-01T00:00:00+00:00
python3 -m kairospy features build --feature-set btc-deribit-trade-skew-v1
python3 -m studies.btc_term_vrp.study
python3 -m studies.btc_skew_predictability.study
python3 -m studies.btc_deribit_skew_spread.study
python3 -m studies.btc_deribit_skew_spread.hedged
python3 -m studies.btc_deribit_skew_spread.threshold_hedge
...
python3 -m kairospy data acquire \
  ...
  --provider binance --venue binance \
  --start 2023-05-18T00:00:00+00:00 --end 2023-10-24T00:00:00+00:00
python3 -m kairospy features build --feature-set btc-term-skew-v1
python3 -m studies.btc_skew_spread_backtest.study
```
